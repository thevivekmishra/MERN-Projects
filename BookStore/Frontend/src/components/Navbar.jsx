            ...
            <div className="navbar mt-2">
                <div className="navbar-start">
                    <div className="dropdown">
                        ...
                        <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-white  dark:bg-gray-800 dark:text-white rounded-box w-52">
                            {navItems}
                        </ul>
                    </div>
                ...
                <div className="navbar-end  space-x-3">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        {authUser ? <Logout /> : (
                            <a className="bg-gray-300 text-white px-4 py-2 text-center rounded-md hover:bg-slate-200  cursor-pointer "
