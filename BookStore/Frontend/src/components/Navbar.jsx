                    ...
                    <div className="navbar-end space-x-3">
                        ...
                        <div className='hidden md:block'>
                            <label className="flex items-center gap-2 px-3 py-1">
                                <input type="text"
                                    className="grow outline-none border rounded-md px-3 py-2 dark:bg-slate-900 dark:text-white"
                                    placeholder="Search" 
                                />
                        ...
                        <div>
                            <label className="swap swap-rotate">
                                ...
                                {/* sun icon */}
                                <svg className="swap-off fill-current w-7 h-"
                        ...
                        <div>
                            <a className="bg-black text-white px-4 py-2 text-center rounded-md hover:bg-slate-800 cursor-pointer"
